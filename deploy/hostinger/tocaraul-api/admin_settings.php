...
/* Sem PDO::ATTR_PERSISTENT: na Hostinger cada worker do PHP-FPM segurava uma conexao
   e o limite de conexoes SIMULTANEAS estourava, derrubando o site com 504. */
function settings_db(): PDO { static $pdo=null; if($pdo instanceof PDO)return $pdo; return $pdo=new PDO('mysql:host='.DB_HOST.';dbname='.DB_NAME.';charset=utf8mb4',DB_USER,DB_PASS,[PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC,PDO::ATTR_EMULATE_PREPARES=>false]); }
