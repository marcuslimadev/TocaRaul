...
/* Uma conexão persistente por worker do PHP-FPM: consultas sucessivas não
   abrem e fecham uma nova conexão MySQL em cada requisição HTTP. */
function settings_db(): PDO { static $pdo=null; if($pdo instanceof PDO)return $pdo; return $pdo=new PDO('mysql:host='.DB_HOST.';dbname='.DB_NAME.';charset=utf8mb4',DB_USER,DB_PASS,[PDO::ATTR_PERSISTENT=>true,PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC,PDO::ATTR_EMULATE_PREPARES=>false,PDO::ATTR_TIMEOUT=>5]); }
